                                ...
                                @foreach ($subjects as $subject)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(Auth::user()->role == 'Admin')
                                                <a href="{{ route('subject.show', $subject) }}" class="btn btn-sm bg-blue text-white m-0 radius" title="view">
                                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('subject.assign-student', $subject) }}" class="btn btn-sm bg-primary text-white m-0 radius" title="Assign Students">
                                            ...
                                            @elseif(Auth::user()->role == 'User')
                                                <a href="{{ route('view.teacher.subject', $subject) }}" class="btn btn-sm bg-blue text-white m-0 radius" title="edit">
                                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                                </a>
                                            @endif
                                        </td>
